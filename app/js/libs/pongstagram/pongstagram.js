+function ($) { "use strict";
  ...
  Pongstgrm.defaults = {
    ...
    , column:           "instagram-col"
    , likeicon:         "fa fa-heart"
    , muteicon:         "fa fa-volume-off"
    , videoicon:        "fa fa-play-circle"
  ...
  Pongstgrm.prototype.template = {
    ...
    //   var _load = '  <button class="'+ options.button +'" data-paginate="'+ options.show +'">'
    ...
    , thumb: function (options) {
        var _thumbnail  = '<div class="'+ options.dflt.column +'">'
            ...
            _thumbnail += ' <div style="background: url('+ options.data.thumbnail +');" class="thumbnail ' + options.dflt.effects + '">'

            _thumbnail += '<div class="insta-overlay"></div>'
    ...
    , bsmodal: function (options) {
        ...
        var modal  = '<div id="'+ options.data.id +'" class="modal fade">'
            modal += '        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><img src="img/theme/x.svg"></button>'
            modal += '  <div class="modal-dialog">'
            modal += '    <div class="modal-content">'
            modal += '      <div class="modal-body">'
            modal += '        <div class="insta-modal-container">'
